...
<script src="/js/app/prod/prodForm.js"></script>
</head>
<body>
<div class="card">
	...
	<form method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
			<label class="form-label" for="lprodGu">분류코드(외래키, 부모테이블:
				LPROD)</label>
			<select id="lprodGu" name="lprodGu" data-init-val="${prod.lprodGu }" class="form-select">
		...
		<div class="form-group">
			<label class="form-label" for="buyerId">거래처코드(외래키, 부모테이블:
				BUYER)</label>
			<select id="buyerId" name="buyerId" data-init-val="${prod.buyerId }" class="form-select">
		...
		<div class="form-group">
			...
			<input type="text" id="prodImg" name="prodImg" value="${prod.prodImg}"
				class="form-control" placeholder="상품이미지" readonly >
